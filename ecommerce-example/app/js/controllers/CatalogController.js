define(['app', 'services/CatalogService', 'filters/startFrom', 'directives/productSummary'], function(app)
{
	/** Catalog view controller */
	app.lazy.controller('CatalogController', ['$scope', 'CatalogService', function($scope, catalogService) {
