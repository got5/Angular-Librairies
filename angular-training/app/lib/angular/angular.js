...
/** Object which stores names of services to reset. */
var servicesToReset = {};
...
function createInjector(modulesToLoad) {
  ...
  function createInternalInjector(cache, factory) {
    ...
    function getService(serviceName) {
	  ...
	  if (servicesToReset[serviceName] == true) {
		delete cache[serviceName];
		servicesToReset[serviceName] = false;
	  }
 ...
 * @description
 */
$CompileProvider.$inject = ['$provide', '$injector'];
function $CompileProvider($provide, $injector) {
  var hasDirectives = {},
      Suffix = 'Directive',
