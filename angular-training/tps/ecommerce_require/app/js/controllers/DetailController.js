define(['app', 'services/CatalogService', 'services/ProductUtils'], function(app)
{
	/** Product detail view controller */
	app.lazy.controller('DetailController', ['$scope', '$routeParams', 'CatalogService', 'ProductUtils',
